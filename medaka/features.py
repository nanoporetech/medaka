...
class FeatureEncoder(object):
    ...
    def bam_to_sample(self, reads_bam, region, reference=None, read_fraction=None, force_py=False):
        ...
        if self.is_compressed:
            aln_to_pairs = functools.partial(medaka.common.yield_compressed_pairs, ref_rle=ref_rle)
        elif self.max_hp_len == 1:
            aln_to_pairs = medaka.common.get_pairs
        else:
            aln_to_pairs = functools.partial(medaka.common.get_pairs_with_hp_len, ref_seq=ref_rle)
